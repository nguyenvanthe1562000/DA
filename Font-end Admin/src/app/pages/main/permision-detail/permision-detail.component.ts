...
export class PermisionDetailComponent extends BaseComponent implements OnInit {
  ...
  // public _selectFunction: any;
  // public _selectedPermision: any;
  // public page = 1;
  // public pageSize = 10;
  ...
  // loadPage(page) { 
  //   this._api.post('/api/Permision/search',{page: page, pageSize: this.pageSize}).takeUntil(this.unsubscribe).subscribe(res => {
  //     this.users = res.data;
